...
const routes = [
    ...
    { path: '/user-profile-edit/:username', name: 'user-profile-edit', component: UserProfileEditPageComponent},
    ...
    { path:'/crop-list/registration',component: CropListAndRegistrationManagementComponent},
    { path: '/crop/:cropId/sowing/:sowingId/:tab?',  name: 'crop-information', component: CropInformationManagementComponent },
